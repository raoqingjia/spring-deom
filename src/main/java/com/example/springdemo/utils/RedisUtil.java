...
public class RedisUtil {
	 ...
	 * @return 是否获取到
	 */
	public  boolean  lock(String predix,String key,int expire){
		String lock = predix + key;
		// 利用lambda表达式
	 ...
	 * @param key
	 */
	public  void delete(String predix,String key) {
		redisTemplate.delete(predix + key);
	}
}
